      ...
      while (iretry == 1) 
         ...
         if (no_change == 0)     
            if (number_groups == 1)
               ...
               fprintf('Horizontal and vertical range of cluster %d %s scores: %d %d \n',number_groups,colors{1},maxxscore-minxscore,maxyscore-minyscore)
            end
            if (number_groups == 2)
               minxscore = 1.e+20;
               maxxscore = -1.e+20;
               ...
               xlabel(stra(selection(1)),'Fontsize',14);
               ylabel(stra(selection(2)),'Fontsize',14);
               title('Figure 5a','Fontsize',14)
               fprintf('Horizontal and vertical range of cluster %d %s scores %d %d \n',number_groups,colors{2},maxxscore-minxscore,maxyscore-minyscore)
            end
            if (number_groups == 3)
               minxscore = 1.e+20;
               maxxscore = -1.e+20;
               ...
               fprintf('Horizontal and vertical range of cluster %d of %s scores %d %d \n',number_groups,colors{3},maxxscore-minxscore,maxyscore-minyscore)
            end
            if (number_groups == 4)
               minxscore = 1.e+20;
               maxxscore = -1.e+20;
               ...
               xlabel(stra(selection(1)),'Fontsize',12);
               ylabel(stra(selection(2)),'Fontsize',12);
               fprintf('Horizontal and vertical range of cluster %d %s scores %d %d \n',number_groups,colors{4},maxxscore-minxscore,maxyscore-minyscore)
            end
         end            
...
for i = 1:number_groups
    ...
    fprintf('Total number of frequencies is %d for group %d \n',numfreq,i);
...
for kk = 1:number_groups
    ...
    if (number_isi(kk) > 1)
       ...
       fprintf('Total number of interspike intervals is %d for group %d \n',ijbinisi,kk)
